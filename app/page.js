    ...
    <div className="min-h-screen grid grid-cols-[240px_1fr]">
      ...
      <aside className="bg-white border-r border-slate-200 p-4">
        ...
        <nav className="space-y-2">
          <a className="block rounded-lg px-3 py-2 hover:bg-slate-100" href="/">Dashboard</a>
          <a className="block rounded-lg px-3 py-2 hover:bg-slate-100" href="/aws">AWS</a>
          <a className="block rounded-lg px-3 py-2 hover:bg-slate-100" href="/datadog">Datadog</a>
          <a className="block rounded-lg px-3 py-2 hover:bg-slate-100" href="/github">GitHub</a>
          <a className="block rounded-lg px-3 py-2 hover:bg-slate-100" href="/settings">Settings</a>
        </nav>
      </aside>
      ...
      <main className="p-6 space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <div className="card">
            ...
            <div className="mt-2 text-xs text-slate-500">Malakye2002 org</div>
          </div>
        ...
        <section className="card">
          ...
          <div className="mt-4 text-sm text-slate-600">
            Connect AWS, Datadog, and GitHub next to replace these placeholders with live data.
          </div>
        </section>
      </main>
    </div>
